"""Run Qwen3-Embedding-0.6B traceability ranking."""
...
DEFAULT_OUT_PATH = "Results/CE/Strict/Qwen0.6B/qwen3_embedding_0.6b_matches_Focus_GPT5.json"

def parse_args() -> argparse.Namespace:
    """Parse command-line options for the Qwen3 0.6B run."""
...
def main() -> None:
    """Run the shared embedding pipeline with Qwen3 0.6B."""
    args = parse_args()
